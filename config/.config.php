...
//基础设置-----------------------------------------------------------------------
$System_Config['key'] = '4429165';			// !!! 瞎jb修改此key为随机字符串确保网站安全 !!!
$System_Config['debug'] =  'false';  //  正式环境请确保为false
$System_Config['appName'] = '翻墙';             //站点名称
$System_Config['baseUrl'] = 'http://fanqiang.co';            // 站点地址
...
$System_Config['min_port']='10000';      //端口池最小值
$System_Config['max_port']='65535';      //端口池最大值
...
$System_Config['db_password'] = 'zy4429165';
...
$System_Config['user_class_expire_default']='12';      //用户等级过期时间，在注册时设置。（小时）
...
$System_Config['reg_method']='chacha20';      //注册时默认加密方式
$System_Config['reg_protocol']='auth_sha1_v4';      //注册时默认协议
...
$System_Config['mu_suffix']='';      //单端口多用户混淆参数后缀
...
$System_Config['inviteNum'] = '999';      // 注册后的邀请链接可用次数
$System_Config['invite_get_money']='0';      //新用户通过私人邀请链接注册，获得奖励金额（鼓励消费）
//邮箱验证
...
$System_Config['checkinMax'] = '20';       //用户签到签到最多流量
$System_Config['code_payback']='10';      //充值返利百分比
$System_Config['invite_gift']='1';      //邀请新用户获得流量奖励，单位G
...
//客服系统设置--------------------------------------------------------------------
//注册地址 https://crisp.chat/
$System_Config['enable_crisp']='true';      //是否开启客服系统
$System_Config['crisp_id']='1008d5b4-320b-4a7c-9928-ffbf70c4ebc5';      //客服系统ID ID查看路径：crisp.chat-->设置-->设置网站-->显示整合性-->html
...
#充值金额选项设定//f2fpay和spay可用
$System_Config['amount']=[2,23,233,2333,23333];
...
$System_Config['pacp_offset']='-20000';      //两种方式相对于ss端口的偏移
